...
import 'package:dromedic_health/src/bindings/dashboard_bindings.dart';
import 'package:dromedic_health/src/bindings/splash_binding.dart';
import 'package:dromedic_health/src/screen/auth_screen/login_screen.dart';
import 'package:dromedic_health/src/screen/auth_screen/sign_up_screen.dart';
import 'package:dromedic_health/src/screen/profile/change_password_screen.dart';
import 'package:dromedic_health/src/screen/auth_screen/forgot_password_screen.dart';
import 'package:dromedic_health/src/screen/auth_screen/phone_login_screen.dart';
import 'package:dromedic_health/src/screen/auth_screen/phone_registration_screen.dart';
import 'package:dromedic_health/src/bindings/payment_binding.dart';
import 'package:dromedic_health/src/screen/category/category_screen.dart';
import 'package:dromedic_health/src/screen/dashboard/dashboard_screen.dart';
import 'package:dromedic_health/src/screen/connection_check/internet_check_view.dart';
import 'package:dromedic_health/src/bindings/news_binding.dart';
import 'package:dromedic_health/src/screen/news/news_details_screen.dart';
import 'package:dromedic_health/src/screen/profile/wallet/recharge_confarmation_screen.dart';
import 'package:dromedic_health/src/screen/splash/splash_screen.dart';
