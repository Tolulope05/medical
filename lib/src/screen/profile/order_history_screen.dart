...
import '../cart/invoice_screen.dart';
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${AppTags.invoice.tr}: #${orderHistoryController.orderListModel.data!.orders![index].orderCode.toString()}",
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: isMobile(context)
                                            ? AppThemeData
                                                .orderHistoryPDFTextStyle_13
                                            : AppThemeData
                                                .orderHistoryPDFTextStyleTab,
                                      ),
                                    ),
                                  ),
                                  Row(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    style: isMobile(context)
                                                        ? AppThemeData
                                                            .orderHistoryStatusTextStyle_13
                                                        : AppThemeData
                                                            .orderHistoryStatusTextStyle_10Tab,
                                                  ),
                                                ),
                                              ),
                                            )
