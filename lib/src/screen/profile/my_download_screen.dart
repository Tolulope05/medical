                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(child: Text(myDownloadController.myDownloadModel.value.downloadUrl![index].productName.toString(),style: AppThemeData.walletTextStyle_12)),

                              Text("\$${myDownloadController.myDownloadModel.value.downloadUrl![index].total.toString()}",style: AppThemeData.balanceTextStyle_16),
                            ],
                          ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(myDownloadController.myDownloadModel.value.downloadUrl![index].date.toString(),style: AppThemeData.walletTextStyle_12,),
                              InkWell(
                                onTap: ()async {
                                  Uri url = Uri.parse(
                                ...
                                child: Container(
                                    ...
                                    child: Text(AppTags.download.tr,style: AppThemeData.buttonDltTextStyle_13),
                                ),
                              ),
                            ],
                          ),
