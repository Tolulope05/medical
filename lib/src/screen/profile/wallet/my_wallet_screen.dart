...
import 'package:dromedic_health/src/controllers/my_wallet_controller.dart';
import 'package:dromedic_health/src/models/user_data_model.dart';
import 'package:dromedic_health/src/utils/responsive.dart';
import 'package:dromedic_health/src/widgets/loader/loader_widget.dart';
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5.h),
                                        Text(
                                            "\$ ${myWalletController.myWalletModel.value.data!.balance!.balance.toString()}",
                                            style: AppThemeData
                                                .balanceTextStyle_16),
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          myWalletController
                                                      ...
                                                      .type ==
                                                  "expense"
                                              ? "-\$ ${myWalletController.myWalletModel.value.data!.recharges![index].amount}"
                                              : "\$ ${myWalletController.myWalletModel.value.data!.recharges![index].amount}",
                                          style: TextStyle(
