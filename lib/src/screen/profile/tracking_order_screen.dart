  ...
  Widget? orderTrackDetails(OrderHistory orderHistory, index, context) {
    switch (orderHistory.event) {
      case "order_create_event":
        return deliveryTrackItem("order_created", "Order Created",
            orderHistory.createdAt, index, context);
      case "delivery_hero_assigned":
        return deliveryTrackItem("delivery_hero_assigned",
            "Delivery Hero Assigned", orderHistory.createdAt, index, context);
      case "delivery_hero_changed":
        return deliveryTrackItem("delivery_hero_changed",
            "Delivery Hero Changed", orderHistory.createdAt, index, context);
      case "order_confirm_event":
        return deliveryTrackItem("order_confirm", "Order Confirm",
            orderHistory.createdAt, index, context);
      case "order_picked_up_event":
        return deliveryTrackItem("order_picked", "Order Picked Up",
            orderHistory.createdAt, index, context);
      case "order_on_the_way_event":
        return deliveryTrackItem("order_on_the_way", "Order On The way",
            orderHistory.createdAt, index, context);
      case "order_pending_event":
        return deliveryTrackItem("order_pending", "Order Pending",
            orderHistory.createdAt, index, context);
      case "order_canceled_event":
        return deliveryTrackItem("order_cancelled", "Order Cancelled",
            orderHistory.createdAt, index, context);
      case "order_delivered_event":
        return deliveryTrackItem("order_delivered", "Order Delivered",
            orderHistory.createdAt, index, context);
      case "pending":
        return deliveryTrackItem(
            "order_delivered", "Order Delivered", "Pending", index, context);
      default:
        return deliveryTrackItem(
          "",
          "",
      ...
      child: ListTile(
        ...
        title: Text(
          ...
          style: isMobile(context)
              ? AppThemeData.trackingOrderTitle
              : AppThemeData.trackingOrderTitleTab,
        ),
        subtitle: Text(
          subtitle,
          style: isMobile(context)
              ? AppThemeData.trackingOrderSubTitle
              : AppThemeData.trackingOrderSubTitleTab,
