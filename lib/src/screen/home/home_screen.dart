...
import 'package:dromedic_health/src/screen/drawer/drawer_screen.dart';
import 'package:dromedic_health/src/screen/news/all_news_screen.dart';
...
import 'package:dromedic_health/src/utils/responsive.dart';
import 'package:dromedic_health/src/widgets/home_product_card.dart';
import 'package:dromedic_health/src/widgets/shop_card_widget.dart';
      ...
      child: Row(
        ...
        children: [
                    ...
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => ProductByCategory(
                            id: homeScreenContentController.homeDataModel.value
                                .data![categoryIndex].categories![index].id,
                            title: homeScreenContentController
                                .homeDataModel
                                .value
                                .data![categoryIndex]
          ...
          Row(
            children: [
              Padding(
                padding: EdgeInsets.only(left: isMobile(context) ? 15.w : 10.w),
                child: Container(
                  height: 15.h,
                  width: 1.5.w,
                  color: Colors.grey,
