...
import 'package:dromedic_health/config.dart';

import 'package:http/http.dart' as http;
import 'package:dromedic_health/src/models/all_brand_model.dart';
import 'package:dromedic_health/src/models/all_campaign_model.dart' as campaign;
import 'package:dromedic_health/src/models/all_category_model.dart';
import 'package:dromedic_health/src/models/all_category_product_model.dart';
import 'package:dromedic_health/src/models/all_news_model.dart' as news;
import 'package:dromedic_health/src/models/all_notifications.dart';
import 'package:dromedic_health/src/models/all_product_model.dart'
    as all_product;
import 'package:dromedic_health/src/models/best_selling_product_model.dart'
    as best_sell;
import 'package:dromedic_health/src/models/campaign_details_model.dart';
import 'package:dromedic_health/src/models/config_model.dart';
import 'package:dromedic_health/src/models/coupon_applied_list.dart';
import 'package:dromedic_health/src/models/coupon_list_model.dart';
import 'package:dromedic_health/src/models/edit_view_model.dart';
import 'package:dromedic_health/src/models/favorite_product_model.dart';
import 'package:dromedic_health/src/models/my_download_model.dart';
import 'package:dromedic_health/src/models/my_reward_model.dart';
import 'package:dromedic_health/src/models/my_wallet_model.dart';
import 'package:dromedic_health/src/models/offer_ending_product_model.dart'
    as offer_ending;
import 'package:dromedic_health/src/models/home_data_model.dart';
import 'package:dromedic_health/src/models/order_list_model.dart';
import 'package:dromedic_health/src/models/product_by_brand_model.dart'
    as brand;
import 'package:dromedic_health/src/models/product_by_campaign_model.dart';
import 'package:dromedic_health/src/models/product_by_category_model.dart'
    as product;
import 'package:dromedic_health/src/models/product_by_shop_model.dart';
import 'package:dromedic_health/src/models/product_details_model.dart';
import 'package:dromedic_health/src/models/profile_data_model.dart';
import 'package:dromedic_health/src/models/search_product_model.dart';
...
import 'package:dromedic_health/src/models/top_shop_model.dart' as top_shop;
import 'package:dromedic_health/src/models/track_order_model.dart';
import 'package:dromedic_health/src/models/user_data_model.dart';
import 'package:dromedic_health/src/models/recent_viewed_product_model.dart'
    as recent_product;
import 'package:dromedic_health/src/models/visit_shop_model.dart';
import 'package:dromedic_health/src/screen/auth_screen/otp_screen.dart';
...
class Repository {
  ...
  //User Phone Login
  Future postPhoneLogin({String? phoneNumber}) async {
    var headers = {"apiKey": Config.apiKey};
  ...
  //User Login
  Future<UserDataModel?> postPhoneLoginOTP(
  ...
  Future postForgetPasswordGetData({String? email}) async {
    ...
    if (response.statusCode == 200) {
      ...
      Get.off(SetNewPasswordScreen(
          email: forgetPassword.data!.email.toString(),
          code: forgetPassword.data!.code));
  ...
  //Order List
  Future<OrderListModel> getOrderList({String? trackId}) async {
    var url =
